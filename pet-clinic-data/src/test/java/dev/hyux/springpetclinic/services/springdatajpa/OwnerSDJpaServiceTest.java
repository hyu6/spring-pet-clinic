package dev.hyux.springpetclinic.services.springdatajpa;

import dev.hyux.springpetclinic.model.Owner;
import dev.hyux.springpetclinic.repositories.OwnerRepository;
import dev.hyux.springpetclinic.repositories.PetRepository;
import dev.hyux.springpetclinic.repositories.PetTypeRepository;
...
class OwnerSDJpaServiceTest {
    ...
    void delete() {
        ...
        verify(ownerRepository).delete(any()); // default times: 1
    }
